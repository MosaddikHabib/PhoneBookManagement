...
int main ()
{
    ...
    cout<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<"\t\t\t\t\t Welcome to my Handmade phone-book management system"<<endl<<"\t\t\t\t\t\t(Press any key to start...)"<<endl<<endl<<endl<<endl<<endl;
    getch();
